    ...
    <>
      <section className='w-full min-h-screen bg-withe md:pt-26 p-4 ' id='contacto'>
            ...
            <form action="https://getform.io/f/f3215236-c97b-4303-83e7-489a7196a4d2" method="POST" enctype="multipart/form-data">
              <div class="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                <div class="flex-block">
                  ...
                  <p class="pt-5 text-2xl texto-gris">Dejanos un mensaje para comunicarte con nosotros.</p>
                </div>
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                  ...
                  <input name="lastname" class="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                    type="text" placeholder="Apellido*" required />
                  <input name="email" class="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                ...
                <div class="my-2 w-1/2 lg:w-1/4">
                  <button class="uppercase text-sm font-bold tracking-wide bg-red-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline" type="submit">
                    Enviar mensaje
                  </button>
                </div>
              </div>
        ...
        <div class="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
          <div>
            <a title="Ir a Whatsapp" href="https://wa.link/xou5om" target="_blank" class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
