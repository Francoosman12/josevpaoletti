...
const Navbar = () => {
  ...
  return (
    <nav className="sticky bg-white top-0 z-50 bg-opacity-50 hover:bg-opacity-100">

      <div className="container mx-auto flex justify-between items-center">
        <div className='container mx-auto flex justify-start items-center'>
          <img className='logo' src="https://i.ibb.co/GdhXk5R/logo-jvp.png" alt="" srcset="" />
        </div>
        <div className="hidden md:flex space-x-6">
          ...
          <a href="#" className="texto-gris border-red-200"><svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
            fill="currentColor"
            viewBox="0 0 24 24">
        ...
        <div className="md:hidden">
          <button
            onClick={toggleMenu}
            className="texto-gris text-2xl focus:outline-none p-8"
          >
            &#9776;
          </button>
        </div>
