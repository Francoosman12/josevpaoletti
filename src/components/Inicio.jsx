    ...
    return (
        ...
        <section className='w-full min-h-screen bg-white md:pt-26 p-4 justify-center' id='inicio'>
            <div className="home flex-block lg:flex">
                <div className='Distribuidora max-w-[1000px] mx-auto pt-10 lg:pt-24 flex-block md:flex-col lg:text-center justify-center w-full md:w-3/5 p-4 h-full lg:w-3/5 text-center'>
                    ...
                    <div className='md:pt-20 lg:flex pt-4'>
                        <div className="iconos-texto flex  justify-center items-center lg:w-3/4">
                        ...
                        <div className="iconos-texto flex  justify-center items-center lg:w-3/4 p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 lg:w-16 lg:h-16 stroke-gray-600">
                        ...
                        <div className="iconos-texto flex justify-center items-center lg:w-3/4 p-2">
                            ...
                            <p className='lg:pl-4 pl-2 texto-gris'>Estrategias comerciales.</p>
                        </div>

                    </div>
                </div>
                <div className='dibujo-home w-full lg:w-2/5 h-full lg:p-4 '>
                    <div className='max-w-[1000px] mx-auto flex md:justify-center md:items-center w-full h-full'>
