        ...
        <section className='w-full min-h-screen bg-white md:pt-18 p-4' id='empresas'>
            <div className=" flex-start max-w-[1200px] mx-auto">
                <div className="mx-auto flex-block lg:flex lg:pt-20 pt-5 justify-center items-center">
                    <div className='w-full max-w-[1000px] pt-5 lg:text-left lg:flex-block justify-center items-center lg:justify-start text-center lg:text-start w-full h-full'>
                        ...
                        <div className='border-red-500 border-2 border-solid lg:w-1/3 w-full lg:mt-6 lg:m-5 md:my-5 my-5'></div>
                    </div>
                    <div className="descripcion w-full lg:w-full p-4 lg:pl-12 pt-10 bg-red-500 rounded-xl">
                        <div>
