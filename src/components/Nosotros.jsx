...
const Nosotros = () => {
  ...
  return (
    ...
    <section className='w-full min-h-screen bg-gray-100 md:pt-20 p-4' id='nosotros'>
      <div className="flex-block justify-center items-center max-w-[1200px] mx-auto">
        <div className='experiencia max-w-[1000px] pt-10 lg:pt-24 lg:text-left justify-center text-center md:text-start w-full h-full'>
          <h1 className='texto-gris lg:text-7xl md:text-7xl text-5xl font-serif text-center lg:text-start'>Experiencia.</h1>
          <p className='texto-gris lg:text-4xl md:text-3xl text-2xl lg:pt-5 pl-2 text-center lg:text-start'>50 años en el Mercado.</p>
        </div>
        <div className="mx-auto video-descripcion flex-block lg:flex lg:pt-20 pt-5 justify-center items-center">
          <div className="video md:w-full text-center">
          ...
          <div className="descripcion md:w-full p-4 lg:pl-12 w-full">
