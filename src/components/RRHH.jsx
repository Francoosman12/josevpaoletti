                ...
                <div className="min-h-screen lg:flex justify-center pt-10">
                    <div className="w-full md:w-1/2 mx-auto flex justify-center items-center">
                        <div className="px-10 text-center">
                            ...
                            <p className="mt-4 md:text-white text-gray-600 md:text-3xl">
                            ...
                            <form action="https://getform.io/f/f3215236-c97b-4303-83e7-489a7196a4d2" method="POST" enctype="multipart/form-data">
                                <input name="file" class="my-4 w-full bg-gray-100 text-gray-900 mt-8 p-3 rounded-lg focus:outline-none focus:shadow-outline"
                    ...
                    <div class="flex items-center justify-center h-full mx-auto my-auto w-full lg:w-1/2 from-indigo-500 to-indigo-800 z-2 lg:pt-16 md:pt-5 pb-8">
                        <div class="bg-white font-semibold text-center rounded-3xl border shadow-lg p-10 max-w-sm md:max-w-md">
